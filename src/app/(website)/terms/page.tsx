...
This is the official Terms of Use Agreement ("Agreement") for the RateMyHST.com website, application or other interactive service ("Site,").   "we," "us" or "our"). The Site is owned, operated and/or provided by RateMyHST, LLC ("RateMyHST," "we," "us," or "our").

Terms of Use Agreement Highlights

For your convenience, the following highlights provide a quick summary of our Terms of Use Agreement. Please read the entire Terms of Use Agreement for more detailed information, as the highlights are only intended as a quick summary and not as a full description of what the Terms of Use Agreement provides. If you have questions about this Terms of Use Agreement, please  contact us 

Terms of Use Agreement Scope; Eligibility; Additional Terms

This Terms of Use Agreement describes your rights and responsibilities relating to the Site that provides an authorized link to this Terms of Use Agreement and is a legally binding agreement between you, on the one hand, and RateMyHST, on the other hand. Additional terms that govern certain products or services (for example, rules of participation in contests and sweepstakes and Site Guidelines) are also applicable if you participate in those products and/or services and are incorporated into these Terms of Use Agreement by reference.
...
These terms and conditions regarding your use of the Site constitute a legally binding agreement between you, on the one hand, and RateMyHST, on the other hand.
    ...
    <div className="flex min-h-screen flex-col bg-white py-10 dark:bg-black md:py-16">
      <div className="mx-auto w-full max-w-5xl px-4">
        <div className="rounded-3xl border border-zinc-200 bg-white/90 p-8 shadow-xl shadow-zinc-200/60 dark:border-zinc-800 dark:bg-zinc-950/60 dark:shadow-black/30">
          <LegalDocument
            title="Terms of Use"
            description="Your agreement with RateMyHST covering eligibility, conduct, and participation across the site."
            content={TERMS_TEXT}
          />
        </div>
      </div>
