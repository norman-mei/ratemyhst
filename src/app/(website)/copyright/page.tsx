...
export const metadata = {
  title: 'Copyright Compliance | RateMyHST',
}

const COPYRIGHT_TEXT = `Copyright Compliance Policy

Last Modified: February 8, 2024

COPYRIGHT COMPLIANCE POLICY

This is the official copyright compliance policy ("Copyright Compliance Policy") for the RateMyHST website, application or other interactive service ("Site"). The Site is owned, operated and/or provided by RateMyHST, LLC ("RateMyHST," "we," "us," or "our"). This Copyright Compliance Policy is a part of the terms and conditions which are set forth in our Terms of Use Agreement. Any terms that are not defined in this Copyright Compliance Policy shall have the meaning given in the Terms of Use Agreement. Both the Terms of Use Agreement and this Copyright Compliance Policy are legally binding on all users. We take protection of copyrights, both our own and others, very seriously. We therefore employ multiple measures to prevent copyright infringement over this Site and to promptly end any infringement that might occur.
...
50 Broad Street, 20th Floor, New York, NY 10004
...
Copyright (c) 2020 - 2024 RateMyHST - All Rights Reserved.`
      ...
      <div className="mx-auto w-full max-w-5xl px-4">
        <div className="rounded-3xl border border-zinc-200 bg-white/90 p-8 shadow-xl shadow-zinc-200/60 dark:border-zinc-800 dark:bg-zinc-950/60 dark:shadow-black/30">
          <LegalDocument
            ...
            description="How to report infringement, submit counternotices, and understand our repeat infringer rules."
